...
DROP TABLE IF EXISTS mini_atm_audit_logs;
DROP TABLE IF EXISTS mini_atm_transactions;
DROP TABLE IF EXISTS mini_atm_branch_balances;
...
-- ------------------------------------------------------------
-- mini_atm_branch_balances (saldo cash & rekening per cabang)
-- ------------------------------------------------------------
CREATE TABLE mini_atm_branch_balances (
...
-- ------------------------------------------------------------
-- mini_atm_transactions
-- ------------------------------------------------------------
CREATE TABLE mini_atm_transactions (
...
-- mini_atm_audit_logs
-- ------------------------------------------------------------
CREATE TABLE mini_atm_audit_logs (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
  branch_id INT UNSIGNED NOT NULL,
  user_id INT UNSIGNED NULL,
